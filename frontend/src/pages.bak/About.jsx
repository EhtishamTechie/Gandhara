...
const About = () => {
  ...
  // Load gallery images from GandharaImages folder
  useEffect(() => {
    const loadGalleryImages = () => {
      // Common image names that might be in the folder (excluding the founder image)
      ...
      possibleImages.forEach((imageName) => {
        const img = new Image();
        img.onload = () => {
          images.push(`/GandharaImages/${imageName}`);
          setGalleryImages([...images]);
        };
        img.onerror = () => {
          loadedCount++;
          // If no specific images found, use some default images
          if (loadedCount === possibleImages.length && images.length === 0) {
            setGalleryImages([
              '/GandharaImages/jaulian.jpg',
              '/GandharaImages/museum.jpg'
            ]);
          }
        };
        img.src = `/GandharaImages/${imageName}`;
      });
    };
            ...
            <div className="relative">
              <div className="relative mx-auto max-w-md">
                ...
                <div className="relative bg-[#0F172A] p-8 rounded-2xl border border-[#334155]">
                  <img
                    src="/GandharaImages/Prof Rashid Transparent.png"
