...
const SearchBar = ({ searchTerm, onSearchChange, totalProducts, filteredCount }) => {
  return (
    <div className="max-w-2xl mx-auto mb-8 animate-fadeIn animation-delay-2">
      <div className="relative">
        ...
        {searchTerm && (
          <button
            ...
            className="absolute inset-y-0 right-0 pr-4 flex items-center text-slate-400 hover:text-indigo-600 transition-colors duration-200 animate-scaleIn"
          >
            <X size={20} />
          </button>
        )}
      ...
      {/* Search Results Info */}
      {searchTerm && (
        <div className="mt-4 text-center text-sm text-slate-600 animate-fadeInUp animation-delay-2">
          {filteredCount === 0 ? (
...
const ImageViewer = ({ images, currentImageIndex, onImageChange, onClose, productTitle, allProducts, currentProduct, onProductChange }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/95 backdrop-blur-md flex items-center justify-center z-[60] animate-fadeIn" onClick={onClose}>
      <div className="relative w-full h-full flex items-center justify-center">
        ...
        {allProducts && allProducts.length > 1 && (
          <>
            <button
              ...
              className="absolute left-4 top-1/2 -translate-y-1/2 z-10 bg-white/10 hover:bg-white/20 backdrop-blur-sm rounded-full p-4 text-white transition-all duration-200 shadow-2xl hover-scale"
            >
              <ChevronLeft size={28} />
            </button>
            ...
            <button
              ...
              className="absolute right-4 top-1/2 -translate-y-1/2 z-10 bg-white/10 hover:bg-white/20 backdrop-blur-sm rounded-full p-4 text-white transition-all duration-200 shadow-2xl hover-scale"
            >
        ...
        <div className="relative max-w-[90vw] max-h-[90vh] overflow-hidden rounded-2xl">
          <div
            ...
            ref={imageRef}
            className={`max-w-full max-h-full cursor-${isZoomed ? 'zoom-out' : 'zoom-in'} transition-transform duration-500 ease-out animate-scaleIn`}
            style={{
        ...
        <button
          onClick={onClose}
          className="absolute top-6 right-6 bg-black/50 hover:bg-black/70 backdrop-blur-sm rounded-full p-3 text-white transition-all duration-200 shadow-2xl hover-scale"
        >
          <X size={24} />
        </button>
  ...
  return (
    <>
      <div className="fixed inset-0 bg-black/60 backdrop-blur-md flex items-center justify-center p-4 z-50 animate-fadeIn" onClick={onClose}>
        <div className="relative bg-white rounded-3xl shadow-2xl w-full max-w-6xl max-h-[95vh] overflow-hidden flex flex-col lg:flex-row animate-scaleIn" onClick={(e) => e.stopPropagation()}>
          {/* Product Navigation Arrows */}
          {allProducts.length > 1 && (
            <>
              <button
                onClick={() => navigateProduct('prev')}
                className="absolute left-2 top-1/2 -translate-y-1/2 z-20 bg-white/90 hover:bg-white backdrop-blur-sm rounded-full p-2 text-slate-700 shadow-lg transition-all duration-200 hover-scale"
              >
                <ChevronLeft size={20} />
              </button>
              ...
              <button
                ...
                className="absolute right-2 top-1/2 -translate-y-1/2 z-20 bg-white/90 hover:bg-white backdrop-blur-sm rounded-full p-2 text-slate-700 shadow-lg transition-all duration-200 hover-scale"
              >
...
const ProductCard = ({ product, index, onClick, searchTerm }) => {
  ...
  return (
    <div
      className={`group bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 overflow-hidden cursor-pointer transform hover:-translate-y-2 animate-fadeInUp animation-delay-${index % 5}`}
          ...
          <div className="absolute bottom-4 left-4 right-4 flex justify-between items-end">
            <div className="flex space-x-2">
              <button
                ...
                className={`p-2 rounded-full backdrop-blur-sm transition-all duration-200 hover-scale ${
                  isFavorite 
            ...
            <div className="bg-white/90 backdrop-blur-sm rounded-full p-2 flex items-center space-x-1 animate-fadeInUp animation-delay-1">
      ...
      <div className="p-5">
        ...
        <div className="flex space-x-2 mt-4">
          ...
          <button
            ...
            className="bg-slate-100 hover:bg-indigo-100 text-slate-700 hover:text-indigo-700 p-2.5 rounded-xl transition-all duration-300 hover-scale"
          >
            <ArrowRight size={16} />
          </button>
        </div>
  ...
  useEffect(() => {
    const fetchCategoryProducts = async () => {
      try {
        ...
        const response = await axios.get(`${API_BASE_URL}/products/category/${encodeURIComponent(categoryName.replace(/-/g, " ").replace(/\b\w/g, function(c){return c.toUpperCase();}))}`);
  ...
  if (error) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-50 flex items-center justify-center">
        <div
          className="text-center max-w-md mx-auto px-4 animate-fadeInUp"
        >
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-50">
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="text-center mb-16 animate-fadeInUp">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-slate-900 mb-4 animate-fadeIn animation-delay-1">
            <span className="bg-gradient-to-r from-indigo-600 via-purple-600 to-indigo-800 bg-clip-text text-transparent">
              {formattedCategoryName}
            </span>
          </h1>
          
          <p className="text-xl text-slate-600 max-w-3xl mx-auto leading-relaxed animate-fadeInUp animation-delay-2">
          ...
          {/* Product Count */}
          <div className="mt-6 animate-fadeInUp animation-delay-3">
        ...
        {/* View Mode Toggle */}
        <div className="flex justify-center mb-8 animate-fadeIn animation-delay-3">
            ...
            <div className="max-w-md mx-auto">
              ...
              {searchTerm && (
                <button
                  ...
                  className="bg-indigo-600 hover:bg-indigo-700 text-white px-6 py-3 rounded-xl font-semibold transition-colors duration-300 hover-scale"
                >
                  Clear Search
                </button>
              )}
        ...
        <div className="text-center mt-16 animate-fadeInUp animation-delay-4">
          <Link
            to="/"
