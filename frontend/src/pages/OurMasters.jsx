...
const OurMasters = () => {
  return (
    <div className="min-h-screen">
      <SEOHead
        title="Our Master Craftsmen - Gandhara Arts & Taxila Stone Crafts"
        description="Meet the skilled artisans who preserve and continue the ancient traditions of Gandhara craftsmanship in Taxila, Pakistan."
        keywords={['gandhara master craftsmen', 'taxila artisans', 'stone carving masters pakistan']}
      />
      {/* Page Header Section */}
