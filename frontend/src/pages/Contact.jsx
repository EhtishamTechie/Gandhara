...
const Contact = () => {
  ...
  return (
    <>
      <SEOHead 
        title="Contact Gandhara Arts - Pakistani Heritage Stone Crafts"
        description="Contact Gandhara Arts for authentic Pakistani stone sculptures, Buddha statues, and Taxila heritage crafts. Visit our gallery in Taxila, Pakistan or reach us via WhatsApp for custom orders."
        keywords="contact gandhara arts, taxila gallery, pakistani stone crafts contact, buddha statues inquiry, heritage crafts pakistan, taxila tourism, stone sculpture orders, custom buddha statues"
        canonicalUrl="https://gandhara-arts-and-taxila-stone-crafts.com/contact"
        ogType="website"
        structuredData={{
          "@context": "https://schema.org",
          "@type": "LocalBusiness",
          "name": "Gandhara Arts",
          "description": "Authentic Pakistani stone sculptures and Buddha statues from Taxila heritage",
          "address": {
            "@type": "PostalAddress",
            "streetAddress": "Heritage Gallery",
            "addressLocality": "Taxila",
            "addressRegion": "Punjab",
            "postalCode": "",
            "addressCountry": "Pakistan"
          },
          "telephone": "+92 300 556 7507",
          "email": "info@gandhara-arts-and-taxila-stone-crafts.com",
          "url": "https://gandhara-arts-and-taxila-stone-crafts.com",
          "image": "https://gandhara-arts-and-taxila-stone-crafts.com/images/gallery-front.jpg",
          "priceRange": "$50-$2000",
          ...
          "sameAs": [
            "https://wa.me/923005567507",
            "https://instagram.com/gandharaarts",
            "https://facebook.com/gandharaarts"
          ]
        }}
      />
      ...
      <section className="bg-[#1E293B] py-16 md:py-20 relative overflow-hidden">
        <div className="container mx-auto px-6 text-center relative z-10">
          ...
          <h1 
            className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-[#E6A44E] via-[#F1C27D] to-[#E6A44E] bg-clip-text text-transparent mb-4 animate-fadeInUp animation-delay-200"
          >
            Get In Touch
          </h1>
          
          <p 
            className="text-lg text-[#E2E8F0] max-w-2xl mx-auto animate-fadeInUp animation-delay-300"
          >
          ...
          <div
            className="mt-6 animate-fadeInUp animation-delay-500"
          >
      ...
      <section className="py-16 md:py-24 relative z-10">
        <div className="container mx-auto px-6">
          ...
          >
            <h2 
              className="text-2xl md:text-3xl font-semibold text-center text-[#F8FAFC] mb-12 animate-fadeInUp"
            >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              {/* WhatsApp Option */}
              <div 
                className="bg-[#1E293B] p-8 rounded-xl shadow-xl border border-[#334155] hover:border-[#25D366] transition-all duration-300 group relative overflow-hidden animate-fadeInUp animation-delay-100"
              >
              ...
              {/* Phone Call Option */}
              <div 
                className="bg-[#1E293B] p-8 rounded-xl shadow-xl border border-[#334155] hover:border-[#E6A44E] transition-all duration-300 group relative overflow-hidden animate-fadeInUp animation-delay-200"
              >
                {/* Decorative corner patterns */}
              ...
              {/* Email Option */}
              <div 
                className="bg-[#1E293B] p-8 rounded-xl shadow-xl border border-[#334155] hover:border-[#F1C27D] transition-all duration-300 group relative overflow-hidden md:col-span-2 lg:col-span-1 animate-fadeInUp animation-delay-300"
              >
                {/* Decorative corner patterns */}
            ...
            {/* Address Information */}
            <div 
              className="mt-16 text-center animate-fadeInUp animation-delay-400"
            >
