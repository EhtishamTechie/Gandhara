...
//       ? `${API_BASE_URL}/api/visit-places/${editingVisitId}`
//       : `${API_BASE_URL}/api/visit-places/add`;
...
const AddPlace = () => {
  ...
  const handleVisitSubmit = async (e) => {
    ...
    if (placeVideo) {
      formData.append("video", placeVideo);
    }
    ...
    try {
      ...
      xhr.onerror = () => {
        ...
        alert("Failed to save visit place. Please try again.");
        setLoading(false);
      };
